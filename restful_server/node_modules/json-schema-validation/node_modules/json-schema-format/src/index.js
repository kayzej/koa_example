!(function(){
    ...
    var _Format = {
        ...
        TMALL_DETAIL: function( value ){
            if( this.URL( value ) ){
                return /http\:\/\/detail(\.daily)?\.tmall\.(net|com)\/item\.(html|htm)\??.*[&|\?]{1}id\=\d{11}($|\D+)/i.test( value );
            }
            else {
                return false;
            }
        ...
        TAOBAO_DETAIL: function( value ){
            if( this.URL( value ) ){
                return /http\:\/\/item(\.daily)?\.taobao\.(net|com)\/item\.(html|htm)\??.*[&|\?]{1}id\=\d{11}($|\D+)/i.test( value );
            }
            else {
                return false;
            }
        ...
        TAOBAO_SHOP: function( value ){
            if( this.URL( value ) ){
                return /http\:\/\/[\w\d]+(\.daily)?\.taobao\.(net|com)/i.test( value );
            }
            else {
                return false;
            }
        ...
        TMALL_SHOP: function( value ){
            if( this.URL( value ) ){
                return /http\:\/\/[\w\d]+(\.daily)?\.tmall\.(net|com)(\/view_shop\.(html|htm))?/i.test( value );
            }
            else {
                return false;
            }
        ...
        CDN_PIC: function( value ){
            if( this.URL( value ) ){
                return /http\:\/\/(gtms\d{2}\.alicdn|img\d{0,2}\.taobaocdn)\.com\/.+\.(png|bmp|gif|jpg|jpeg|webp)$/i.test( value );
            }
            else {
                return false;
            }
