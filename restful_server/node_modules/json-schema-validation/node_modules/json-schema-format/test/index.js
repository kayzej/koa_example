...
describe( 'json-schema-format', function(){
    ...
    describe( 'format测试', function(){
        it( 'date-time', function( done ){
            Assert.equal( Format( 'date-time', '2002-11-26T00:03:44.32Z' ), true );
            Assert.equal( Format( 'date-time', '14768976543' ), false );
            done();
        });
        ...
        it( 'CDN_PIC', function( done ){
            ...
            Assert.equal( Format( 'CDN_PIC', 'http://img.taobaocdn.com/bao/uploaded/i1/T1eE0oFyBsXXXy1_P2-941-415.jpg_160x160.jpg' ), true );
